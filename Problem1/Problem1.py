...
print "\nselect last_name, first_name, title, salary from s_emp where salary > 1500 and dept_id > 40: ", [[i[1], i[2], i[6], i[7]] for i in s_emp[1::] if i[7] > 1500 and int(i[9]) > 40]

#select last_name, first_name, title, salary from s_emp where salary > 1500 and dept_id > 40 order by last_name;
print "\nselect last_name, first_name, title, salary from s_emp where salary > 1500 and dept_id > 40 order by last_name: ", sorted([[i[1], i[2], i[6], i[7]] for i in s_emp[1::] if i[7] > 1500 and int(i[9]) > 40], key = lambda x: x[0])

#select last_name, first_name, title, salary from s_emp where salary > 1500 and dept_id > 40 order by salary desc;
print "\nselect last_name, first_name, title, salary from s_emp where salary > 1500 and dept_id > 40 order by salary desc: ", sorted([[i[1], i[2], i[6], i[7]] for i in s_emp[1::] if i[7] > 1500 and int(i[9]) > 40], key = lambda x: int(x[3]), reverse = True)
